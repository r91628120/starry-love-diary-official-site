...
export function HomePage() {
  ...
  return <>
    ...
    <section className="download-callout section"><div><p className="eyebrow">即將推出</p><h2>星星戀愛日記，即將與你見面。</h2><p>App Store · Coming soon / Google Play · Coming soon</p></div><img className="download-callout__cat" src={`${import.meta.env.BASE_URL}assets/final-black-cat.webp`} alt="" aria-hidden="true" /></section>
  </>
}
